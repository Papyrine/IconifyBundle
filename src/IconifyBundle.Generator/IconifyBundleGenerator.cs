...
/// <summary>
/// The strongly-typed pack class (one member per icon) is compiled into each <c>IconifyBundle.&lt;Pack&gt;</c>
...
/// <c>IconifyBundleExtractDisk</c> MSBuild property.
/// </summary>
    ...
    IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var extractDisk = context.AnalyzerConfigOptionsProvider.Select(
            (provider, _) =>
                provider.GlobalOptions.TryGetValue("build_property.IconifyBundleExtractDisk", out var value) &&
